...
| 2.3 | Config constants | `backend/config.py` | Claude | ✅ | Written 2026-04-15. Exports `COLLECTION_NAME`, `VECTORS` (4 named specs), `VECTORAI_ADDR`, `RRF_K=60`, `PER_VECTOR_CANDIDATES=100`, `STATE_NAMES` (50+DC). |
...
```python
# backend/config.py
PER_VECTOR_CANDIDATES = 100  # fan-out pool size before RRF fusion
```
